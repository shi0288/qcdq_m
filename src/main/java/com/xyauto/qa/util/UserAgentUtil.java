...
public class UserAgentUtil {
    ...
    public static final String PC_INDEX = "http://ask.qichedaquan.com/";
    public static final String PC_QUESTION_DETAIL = "http://ask.qichedaquan.com/detail/";
    public static final String PC_QUESTION_DETAIL_ANS = "http://ask.qichedaquan.com/detail_ans/";
    public static final String PC_EXPERT = "http://ask.qichedaquan.com/user/";
    public static final String PC_OFFERING = "http://ask.qichedaquan.com/offering?comment_id=";
    public static final String PC_ATTACH = "http://ask.qichedaquan.com/attach";
